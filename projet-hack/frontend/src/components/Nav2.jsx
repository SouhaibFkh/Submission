import a from '../assets/dash1.svg'
import { Link, useNavigate } from 'react-router-dom';
import b  from '../assets/acc.svg'
import c  from '../assets/ana2.svg'
  ...
  const navigate=useNavigate;
    return (
        ...
        <div className='h-full w-[20%]  bg-[#FFFFFF] flex justify-center items-center p-1 shadow-sm '>
            ...
            <div className=" text-sm flex mt-9 flex-col gap-14  justify-center items-center w-[70%]   h-[70vh]  p-1">
            <Link className='poppins-bold flex rounded-sm  gap-4 h-11 w-full bg-[#F8F8F8] hover:text-[#186F65]' to="/" onClick={()=>{navigate('/')}} ><span><img src={a} /></span><span className='mt-2'>Dashboard</span></Link>
            ...
            <Link className='poppins-bold flex rounded-sm gap-4 h-11 w-full hover:bg-[#F8F8F8] text-[#186F65]' to="/ana" onClick={()=>{navigate('/accf')}} ><span><img src={c} /></span><span className='mt-2'>Sensibilisation</span></Link>
