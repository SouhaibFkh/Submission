  ...
  const navigate=useNavigate;
    return (
        ...
        <div className='h-full w-[20%]  bg-[#FFFFFF] flex justify-center items-center p-1 shadow-sm '>
            ...
            <div className=" text-sm flex mt-9 flex-col gap-5  justify-center items-center w-[70%]   h-[70vh]  p-1">
            ...
            <Link className='poppins-bold flex rounded-sm gap-4 h-11 w-full hover:bg-[#F8F8F8] text-[#186F65]' to="/accf" onClick={()=>{navigate('/ana')}} ><span><img src={b} /></span><span className='mt'>Account Managment</span></Link>
